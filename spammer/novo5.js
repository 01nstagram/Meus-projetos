...
const commands = [
    ...
    new SlashCommandBuilder().setName('setspam').setDescription('Configurar a mensagem de spam').addStringOption(option => option.setName('message').setDescription('Mensagem de spam personalizada').setRequired(true)),
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.commandName === 'setspam') {
        ...
        await interaction.reply({ content: 'Mensagem de spam personalizada configurada com sucesso!', ephemeral: true });
    }
});
