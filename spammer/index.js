...
const { Client, GatewayIntentBits, ButtonBuilder, ActionRowBuilder, ButtonStyle, MessageFlags, REST, Routes, SlashCommandBuilder, Collection } = require('discord.js');
...
client.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.commandName === 'waifu') {
        ...
        await interaction.reply({
            content: 'Clique no botão para receber **4 waifus!**',
            components: [row],
            flags: MessageFlags.Ephemeral
        });
    }
