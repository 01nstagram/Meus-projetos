...
try:
    ...
    print(f'Modules of the python library required for 1nstagram are not installed, make sure you have correctly installed python and have launched the "Setup.py" file which will install all the necessary modules.')
    input(f'Error: {e}')

color_webhook = 0xa80505
username_webhook = name_tool
avatar_webhook = 'https://cdn.discordapp.com/attachments/1265435106500411412/1352870415751581819/xPr6RjFGSUOhqW.jpg?ex=67df9642&is=67de44c2&hm=ca647e0cbeece7866b2df45773646b6434c411f3d723693a8548ce5386e0f6dc&'
...
def Censored(text):
    censored = ["1nstagram", creator, website]
...
def Reset():
    if os_name == "Windows":
        file = ['python', os.path.join(tool_path, "tokeninfo.py")]
        subprocess.run(file)

    elif os_name == "Linux":
        file = ['python3', os.path.join(tool_path, "tokeninfo.py")]
        subprocess.run(file)
