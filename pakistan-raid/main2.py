...
async def main():
    ...
    # CARREGA O TICKET MANUALMENTE
    try:
        await bot.load_extension("comandos.ticket")
        print("🎫 Sistema de ticket carregado com sucesso!")
    except Exception as e:
        print(f"❌ Erro ao carregar o ticket.py: {e}")

    await bot.start("MTM1MzcyMzAwOTk0MDE5NzM4Nw.GF-QGp.LF6WBUIzkO8BDQajEC_KMnPPMA9iXNoCp3FNFA")  # troca pro token certo seu burro
